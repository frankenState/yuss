...
<div class="col-md-6 col-md-offset-3">
	<div class="panel panel-primary" style="margin-top:2%">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" action="{{ url('/question/update/' . $question->id) }}" method="POST" enctype="multipart/form-data">
				{{csrf_field()}}
			  <div class="form-group">
			    <label for="question_txt" class="col-sm-2 control-label">Question :</label>
			    <div class="col-sm-10">
<textarea placeholder="Your question..." name="question_txt" class="form-control">{{$question->question_txt}}</textarea>
			    </div>
			  </div>
			  <div class="form-group">
